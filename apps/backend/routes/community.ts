...
import { reportPost, takeDownPost, restorePost } from '../controllers/postModerationController.js';
import {
  addComment,
  editComment,
  deleteComment,
...
router.post('/posts/:id/take-down', protect, takeDownPost);
router.post('/posts/:id/restore', protect, restorePost);
